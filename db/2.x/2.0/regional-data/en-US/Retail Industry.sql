...
SELECT 'DEF', 'Default',            finance.get_account_id_by_account_number('20100') UNION ALL
SELECT 'OUE', 'Outdoor Employees',  finance.get_account_id_by_account_number('20100') UNION ALL
SELECT 'PRO', 'Project Employees',  finance.get_account_id_by_account_number('20100') UNION ALL
SELECT 'SUP', 'Support Staffs',     finance.get_account_id_by_account_number('20100') UNION ALL
SELECT 'ENG', 'Engineers',          finance.get_account_id_by_account_number('20100');
