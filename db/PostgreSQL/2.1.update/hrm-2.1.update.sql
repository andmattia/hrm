-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/01.types-domains-tables-and-constraints/tables-and-constraints.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/03.menus/menus.sql --<--<--
...
-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/04.default-values/01.default-values.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/05.scrud-views/empty.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/05.selector-views/empty.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/05.views/empty.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/06.report-views/empty.sql --<--<--


-->-->-- src/Frapid.Web/Areas/MixERP.HRM/db/PostgreSQL/2.1.update/src/99.ownership.sql --<--<--
DO
$$
    DECLARE this record;
BEGIN
