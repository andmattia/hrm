...
"\";\r\n\r\n    scrudFactory.viewAPI = \"/api/views/hrm/leave-application-scrud-view\";\r" +
"\n    scrudFactory.viewTableName = \"hrm.leave_application_scrud_view\";\r\n\r\n    scr" +
"udFactory.formAPI = \"/api/forms/hrm/leave-applications\";\r\n    scrudFactory.formT" +
"ableName = \"hrm.leave_applications\";\r\n\r\n    scrudFactory.excludedColumns = [\"Pho" +
"to\"];\r\n    scrudFactory.hiddenColumns = [\"EnteredBy\", \"AppliedOn\", \"Verification" +
"StatusId\", \"VerifiedByUserId\", \"VerifiedOn\", \"VerificationReason\"];\r\n\r\n    scrud" +
"Factory.live = \"EmployeeId\";\r\n\r\n    scrudFactory.layout = [\r\n        {\r\n        " +
"    tab: \"\",\r\n            fields: [\r\n                [\"LeaveApplicationId\", \"Lea" +
"veTypeId\"],\r\n                [\"StartDate\", \"EndDate\"],\r\n                [\"Reason" +
"\"]\r\n            ]\r\n        }\r\n    ];\r\n\r\n    scrudFactory.keys = [\r\n        {\r\n  " +
"          property: \"LeaveTypeId\",\r\n            url: \'/api/forms/hrm/leave-types" +
"/display-fields\',\r\n            data: null,\r\n            valueField: \"Key\",\r\n    " +
"        textField: \"Value\"\r\n        },\r\n        {\r\n            property: \"Employ" +
